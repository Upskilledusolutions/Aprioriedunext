    ...
    <div className={show ? `${styles.fixed}` : `${styles.none}`}>
      ...
      >
        ...
        <ul className={click ? `${styles.navlinks1}` : `${styles.navlinks}`}>
          ...
          <Link onClick={clickfn2} href='/games' className={isActive('/games') ? `${styles.link} ${styles.li} ${styles.ul} ${styles.active}` : `${styles.link} ${styles.li} ${styles.ul}  ${styles.hovereffect}`}>Games</Link>
          ...
          <div className={styles.userInfoContainer}>
            ...
            {isDropdownVisible && (
              <div className={styles.dropdownMenu}>
                ...
                {/* {user.type === 'all' && <Link className={styles.logoutButton} onClick={toggleDropdown} href='/AdminPanel'>Admin Panel</Link>}  */}
