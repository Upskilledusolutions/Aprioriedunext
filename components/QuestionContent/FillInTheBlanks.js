...
const FillInTheBlanksComponent = ({
  ...
  const language = routePath.split('/')[2].slice(0, 3); // Extracts "Eng", "Fre", etc.
  ...
  const selectedLanguage = languageMappings[language] || 'English';
  ...
  const layout = languageLayouts[selectedLanguage] || languageLayouts.French;
