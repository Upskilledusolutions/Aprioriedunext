export const quiz = [
    {
      ...
      questions: [
        ...
        // 2 Drag and Drop
        {
          question: 'Drag and drop the correct verb into the blank: Je _____ un livre.',
          choices: ['lis', 'écris', 'mange', 'parle'],
          type: 'DragAndDrop',
          correctAnswer: 'lis',
        },
        {
          question: 'Drag and drop the correct verb into the blank: Il _____ un café.',
          choices: ['boit', 'court', 'mange', 'lit'],
          type: 'DragAndDrop',
          correctAnswer: 'boit',
        },
      ],
