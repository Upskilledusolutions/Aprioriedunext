...
import { youdata } from "../../Data/Conversationdata/spanishc1"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  const unlockedPages = useSelector((state) => state.unlockedPages.unlockedPagesSpanishC1);
  ...
  return (
    <>
      <Head>
        <title>Spanish Conversation</title>
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Spanish Conversation (C1)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/SpanishConversationC1/${data.id}`}>
                <div className={styles.imgcont}>
                  <div className={styles.logocont}>
                    <Image
