...
import { youdata } from "../../Data/Conversationdata/germanb1"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  const unlockedPages = useSelector((state) => state.unlockedPages.unlockedPagesGermanA2);
  ...
  return (
    <>
      <Head>
        <title>German Conversation</title>
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>German Conversation (A2)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/GermanConversationA2/${data.id}`}>
                <div className={styles.imgcont}>
                  <div className={styles.logocont}>
                    <Image
