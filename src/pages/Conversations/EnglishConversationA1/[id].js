...
import { youdata } from "../../../Data/Conversationdata/englisha1.js"; // Importing the quiz data
    ...
    <>
      ...
      return (
        <div key={data.id} className={styles.videocontainer1}>
          {isUnlocked ?  <Link className={styles.link1} href={`/Conversations/EnglishConversationA1/${data.id}`}>
