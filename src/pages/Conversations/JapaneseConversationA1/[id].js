...
import { youdata } from "../../../Data/Conversationdata/Japnesea1.js"; // Importing the quiz data
    ...
    <>
      ...
      return (
        <div key={data.id} className={styles.videocontainer1}>
          {isUnlocked ?  <Link className={styles.link1} href={`/Conversations/JapaneseConversationA1/${data.id}`}>
