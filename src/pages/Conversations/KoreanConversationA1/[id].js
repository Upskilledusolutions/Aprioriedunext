...
import { youdata } from "../../../Data/Conversationdata/Koreana1.js"; // Importing the quiz data
    ...
    <>
      ...
      return (
        <div key={data.id} className={styles.videocontainer1}>
          {isUnlocked ?  <Link className={styles.link1} href={`/Conversations/KoreanConversationA1/${data.id}`}>
