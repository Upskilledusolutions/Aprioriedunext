...
import { youdata } from "../../Data/Conversationdata/Italiana1.js"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  const unlockedPages = useSelector((state) => state.unlockedPages.unlockedPagesItalian);
  ...
  return (
    <>
      <Head>
        <title>Italian Conversation</title>
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Italian Conversation (A1)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/ItalianConversationA1/${data.id}`}>
                <div className={styles.imgcont}>
                  <div className={styles.logocont}>
                    <Image
