...
import { youdata } from "../../Data/Conversationdata/spanisha1.js"; // Importing the quiz data
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Spanish Conversation (A1)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/SpanishConversationA1/${data.id}`}>
                <div className={styles.imgcont}>
                  <div className={styles.logocont}>
                    <Image
