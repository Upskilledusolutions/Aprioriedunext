...
import { youdata } from "../../Data/Conversationdata/frenchc1.js"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  const unlockedPages = useSelector((state) => state.unlockedPages.unlockedPagesFrenchC1);
  ...
  return (
    <>
      <Head>
        <title>French Conversation</title>
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>French Conversation (C1)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/FrenchConversationC1/${data.id}`}>
