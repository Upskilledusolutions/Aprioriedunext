...
import { youdata } from "../../Data/Conversationdata/spanishb1"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  const unlockedPages = useSelector((state) => state.unlockedPages.unlockedPagesSpanishA2);
      ...
      <main>
        <div className={styles.container1}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Spanish Conversation (A2)</div>
          </div>
...
{isUnlocked || user.type === 'all' ? (
              <Link className={styles.link} href={`/Conversations/SpanishConversationA2/${data.id}`}>
                <div className={styles.imgcont}>
                  <div className={styles.logocont}>
                    <Image
