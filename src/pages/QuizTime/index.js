  ...
  return (
    <>
      ...
      <div className={styles.container}>
        <div className={styles.headcont}><div className={styles.mainheading}>Quiz Time</div></div>
    ...
    <div className={styles.cards}>
      ...
      <div className={styles.card}>
        ...
        <Link href='/QuizTime/FrenchQuizs' className={styles.btn}>Start Quiz</Link>
      </div>
      ...
      <div className={styles.card}>
        ...
        <Link href='/QuizTime/SpanishQuizs' className={styles.btn}>Start Quiz</Link>
      </div>
      ...
      <div className={styles.card}>
        ...
        <Link href='/QuizTime/GermanQuizs' className={styles.btn}>Start Quiz</Link>
      </div>
      ...
      <div className={styles.card}>
        ...
        <Link href='/QuizTime/ItalianQuizs' className={styles.btn}>Start Quiz</Link>
      </div>
