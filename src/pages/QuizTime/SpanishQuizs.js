    ...
    <>
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}><div className={styles.mainheading}>Spanish Quiz</div></div>

          <div className={styles.cards1}>

            {quiz.map(data=><Link href={`SpanishQuiz/${data.quiz}`} className={styles.link}>
