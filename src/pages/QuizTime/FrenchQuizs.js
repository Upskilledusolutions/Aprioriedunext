...
import { quiz } from "../../Data/frenchquestions"; // Importing the quiz data
    ...
    <>
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}><div className={styles.mainheading}>French Quiz</div></div>

          <div className={styles.cards1}>

            {quiz.map(data=><Link href={`FrenchQuiz/${data.quiz}`} className={styles.link}>
