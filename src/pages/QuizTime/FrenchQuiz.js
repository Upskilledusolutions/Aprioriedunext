...
import { quiz } from "../../Data/frenchquestions";
...
//             <h2>{question}</h2>
//             <ul>{choices.map((answer, index) => (
//                 <li onClick={() => onAnswerSelected(answer, index)} key={answer} className={selectedAnswerIndex === index ? `${styles.selectedanswer}` : null}>{answer}</li>
//               ))}
//             </ul>
//             <div className={styles.flexright}>
//               <button onClick={onClickNext} disabled={selectedAnswerIndex === null}>
...
//             <p>Wrong Answers:<span> {10 - result.correctAnswers}</span></p>
//             <div className={styles.flex}> 
//               <Link className={styles.btns} href="/QuizTime">Go Back</Link>
//                 <div className={styles.btns} onClick={reloadPage}>Retry</div>
//             </div>
