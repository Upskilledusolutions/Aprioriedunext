      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Speaking Tasks</div>
          </div>

          <div className={styles.maintext}>
            Explore the beauty of new cultures by mastering Spanish, French, or German through our engaging Translation Exercises. Whether you're a beginner or looking to perfect your fluency, our language courses are designed to guide you at every step.
          </div>
            ...
            {sortedCards.map((card) => (
              ...
              >
                ...
                {!isCardLocked(card.type) ? (
                  <Link href={`/SpeakingTasks/${card.link}`} className={styles.btn}>
                    Start Learning
                  </Link>
                ) : (
