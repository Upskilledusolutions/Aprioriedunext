...
import { data } from "../../Data/Speechtracker/englishb1"; // Importing the quiz data
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>English Reading Practice (B1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`EnglishReadingPageB1/${data.id}`} className={styles.link}>
                  {isLocked && (
