...
export default function VerbalTrack() {
  const pilotActivities = getActivities({ track: "verbal", levelId: "L1", stageId: "S1" });

  return (
    <>
      <Head><title>Verbal Skills | Reasoning & Academic Skills</title><meta name="description" content="Build verbal reasoning, critical reading, analytical writing and research skills." /></Head>
      <main style={{ minHeight: "80vh", padding: "52px 20px 80px", background: "var(--surface)" }}>
        <div style={{ maxWidth: 1150, margin: "0 auto" }}>
          ...
          <div style={{ marginTop: 34, maxWidth: 800 }}>
            <p style={{ color: "var(--blue)", fontWeight: 800, letterSpacing: ".08em", textTransform: "uppercase", fontSize: 13, marginBottom: 12 }}>Verbal Skills</p>
          ...
          <section style={{ marginTop: 40, padding: 26, borderRadius: 18, background: "var(--card)", border: "1px solid var(--border)" }}>
            ...
            <p style={{ color: "var(--muted)", lineHeight: 1.6 }}>Start with claims and evidence. Explore introduces the idea; Extend raises the reasoning challenge while staying anchored to Grade 3.</p>
