...
const startButton = { display: "inline-block", marginTop: 26, padding: "13px 20px", borderRadius: 10, background: "var(--blue)", color: "#fff", textDecoration: "none", fontWeight: 800 };
    ...
    <>
      ...
      <main style={{ minHeight: "80vh", padding: "52px 20px 80px", background: "var(--surface)" }}>
        <div style={{ maxWidth: 1150, margin: "0 auto" }}>
          ...
          <Link href="/Auth" style={startButton}>Start Solving</Link>
