...
import { data } from '../../../Data/Languagelessons/germanc1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsGermanC1);
