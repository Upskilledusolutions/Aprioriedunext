...
import { data } from '../../../Data/Languagelessons/englisha1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsEnglishA1);
