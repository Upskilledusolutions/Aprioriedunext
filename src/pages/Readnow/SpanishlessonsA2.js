...
import { data } from "../../Data/Languagelessons/spanisha2"; // Importing the quiz data
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`SpanishlessonA2/${data.id}`} className={styles.link}>
                  {isLocked && (
