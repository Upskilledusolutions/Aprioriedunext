...
import { data } from '../../../Data/Languagelessons/frenchc1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsFrenchC1);
