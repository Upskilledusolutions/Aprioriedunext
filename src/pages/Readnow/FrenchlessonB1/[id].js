...
import { data } from '../../../Data/Languagelessons/frenchb1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsFrenchB1);
