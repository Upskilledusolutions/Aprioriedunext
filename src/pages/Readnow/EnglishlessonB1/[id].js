...
import { data } from '../../../Data/Languagelessons/englishb1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsEnglishB1);
