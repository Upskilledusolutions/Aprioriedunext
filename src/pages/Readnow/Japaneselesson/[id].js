...
import { data } from '../../../Data/Languagelessons/Japanese'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsJapanese);
