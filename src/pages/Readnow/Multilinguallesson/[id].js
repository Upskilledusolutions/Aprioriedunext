...
import { data } from '../../../Data/Languagelessons/mltilingual'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedLessons.unlockedLessonsMultilingual);
  const subject = 'Multilingual';
