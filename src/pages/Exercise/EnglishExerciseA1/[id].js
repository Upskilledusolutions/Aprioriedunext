...
import { quiz } from "../../../Data/ExerciseData/Englisha1"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesEnglishA1);
  const completedQuizzes = useSelector(state => state.finishedQuizzes.completedQuizzes);
  const subject = 'EnglishA1';
