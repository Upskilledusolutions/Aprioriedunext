...
import { quiz } from "../../../Data/ExerciseData/italian"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesItalian);
