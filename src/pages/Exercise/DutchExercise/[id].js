...
import { quiz } from "../../../Data/ExerciseData/dutch"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesDutch);
