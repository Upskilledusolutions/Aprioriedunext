...
import { quiz } from "../../../Data/ExerciseData/Englishb1"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesEnglishB1);
