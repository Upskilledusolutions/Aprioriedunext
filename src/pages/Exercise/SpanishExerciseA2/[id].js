...
import { quiz } from "../../../Data/ExerciseData/spanisha2"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesSpanishA2);
  const completedQuizzes = useSelector(state => state.finishedQuizzes.completedQuizzes);
  const subject = 'SpanishA2';
