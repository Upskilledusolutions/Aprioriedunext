...
import { quiz } from "../../../Data/ExerciseData/germanc1"; // Importing the quiz data
...
const Quiz = () => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedExercises.unlockedExercisesGermanC1);
