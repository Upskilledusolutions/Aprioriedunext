...
import { data } from '../../../Data/ReadingAssignments/Korean'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsKorean);
