...
import { data } from "../../Data/ReadingAssignments/Frenchc1"; // Importing the quiz data
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>French Reading Assignments (C1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`FrenchReadingAssignmentC1/${data.id}`} className={styles.link}>
                  {isLocked && (
