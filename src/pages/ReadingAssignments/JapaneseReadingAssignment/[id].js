...
import { data } from '../../../Data/ReadingAssignments/Japanese'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsJapanese);
