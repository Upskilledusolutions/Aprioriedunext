...
import { data } from "../../Data/ReadingAssignments/German"; // Importing the quiz data
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>German Reading Assignments (A1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`GermanReadingAssignment/${data.id}`} className={styles.link}>
                  {isLocked && (
