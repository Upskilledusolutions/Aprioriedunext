...
import { data } from '../../../Data/ReadingAssignments/Russian'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsRussian);
