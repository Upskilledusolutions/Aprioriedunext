...
import { data } from "../../Data/ReadingAssignments/Spanishc1"; // Importing the quiz data
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Spanish Reading Assignments (C1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`SpanishReadingAssignmentC1/${data.id}`} className={styles.link}>
                  {isLocked && (
