...
import { data } from '../../../Data/ReadingAssignments/Italian'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsItalian);
