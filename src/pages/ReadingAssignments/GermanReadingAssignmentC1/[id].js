...
import { data } from '../../../Data/ReadingAssignments/Germanc1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsGermanC1);
