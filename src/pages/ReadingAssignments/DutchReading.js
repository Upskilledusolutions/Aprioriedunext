...
import { data } from "../../Data/ReadingAssignments/Dutch"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  return (
    <>
      <Head>
        <title>Dutch Reading Assignments</title>
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>Dutch Reading Assignments (A1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`DutchReadingAssignment/${data.id}`} className={styles.link}>
                  {isLocked && (
