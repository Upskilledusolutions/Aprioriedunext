...
import { data } from '../../../Data/ListeningAssignments/Spanishc1'; // Import your JSON data
...
const LessonPage = ({ lesson }) => {
  ...
  const unlockedPages = useSelector((state) => state.unlockedAssignments.unlockedAssignmentsSpanishC1);
