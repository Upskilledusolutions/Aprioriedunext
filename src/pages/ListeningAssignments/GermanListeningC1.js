...
import { data } from "../../Data/ListeningAssignments/Germanc1"; // Importing the quiz data
...
export default function FrenchQuizes() {
  ...
  return (
    <>
      <Head>
        <title>German Listening Assignments</title>
      ...
      <main>
        <div className={styles.container}>
          <div className={styles.headcont}>
            <div className={styles.mainheading}>German Listening Assignments (C1)</div>
          </div>
            ...
            {data.map((data, index) => {
              ...
              return (
                <div key={data.quiz} className={`${styles.card1} ${isLocked ? styles.locked : ''}`}>
                  {isUnlocked || user.type === 'all' ? <Link href={`GermanListeningAssignmentC1/${data.id}`} className={styles.link}>
                  {isLocked && (
